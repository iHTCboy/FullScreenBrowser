...
@interface ViewController ()<UISearchBarDelegate,UIWebViewDelegate,UIScrollViewDelegate>
...
- (IBAction)setingButton:(id)sender {
    ...
    SystemSetingViewController * nav = [[SystemSetingViewController alloc]init];
